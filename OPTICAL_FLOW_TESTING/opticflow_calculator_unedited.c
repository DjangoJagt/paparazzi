/*
 * This file includes the optical flow calculator. This file is 
 * unedited from the origional version already given in the 
 * computer vision folder of the repository. This file bookkeeps al
 * nessecary variables. The actual calculation of the optical flow is
 * performed in the size_divergence_split.c file called by the size_divergence 
 * function. 
 */
...
// Own Header
#include "opticflow_calculator_unedited.h"
